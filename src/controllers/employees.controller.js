...
var EmployeesController = /** @class */ (function () {
    ...
    EmployeesController.getAll = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var stats, all, page, ITEMS_PER_PAGE, pages, employees;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, prisma.employee.aggregate({
                                _count: {
                                    id: true
                                }
                            })];
    ...
    EmployeesController.getOne = function (req, res) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var stats, employee, reportId, reportFirstName, reportLastName;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, prisma.employee.findUnique({
                                where: {
                    ...
                    case 1:
                        ...
                        reportId = (_a = employee === null || employee === void 0 ? void 0 : employee.employee) === null || _a === void 0 ? void 0 : _a.id;
                        reportFirstName = (_b = employee === null || employee === void 0 ? void 0 : employee.employee) === null || _b === void 0 ? void 0 : _b.firstName;
                        reportLastName = (_c = employee === null || employee === void 0 ? void 0 : employee.employee) === null || _c === void 0 ? void 0 : _c.lastName;
                        employee === null || employee === void 0 ? true : delete employee.employee;
                        res.send({
                            stats: stats,
                            employee: __assign({ reportId: reportId, reportFirstName: reportFirstName, reportLastName: reportLastName }, employee)
                        });
                        return [2 /*return*/];
                }
            });
