...
var SuppliersController = /** @class */ (function () {
    ...
    SuppliersController.getAll = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var stats, all, page, ITEMS_PER_PAGE, pages, suppliers;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, prisma.supplier.aggregate({
                                _count: {
                                    id: true
                                }
                            })];
                    case 1:
                        ...
                        return [4 /*yield*/, prisma.supplier.findMany({
    ...
    SuppliersController.getOne = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var stats, supplier;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, prisma.supplier.findUnique({
                                where: {
